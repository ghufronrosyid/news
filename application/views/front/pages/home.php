               ...
               <div class="col-lg-4">
                  <div class="container">
                     <div class="date text-center">
                        ...
                        <a href="<?= base_url("blog/read/$f->seo_title") ?>"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo date('d F, Y'); ?></a>
                     </div>
      ...
      <div class="container">
            <div class="row">
               <div class="col-lg-6 col-sm-4">
                  <h4 class="float-right my-2 text-dark">Subscribe GNews</h4>
               </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-8">
            ...
            <div class="row mt-5">
               <div class="col text-center">
                  <a href="<?= base_url('blog') ?>" class="genric-btn danger-border circle arrow">Tampilkan Lebih Banyak<span class="lnr lnr-arrow-right"></span></a>
               </div>
            </div>
