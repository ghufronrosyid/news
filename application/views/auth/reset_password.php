				...
				<div class="card card-signin my-5">
					...
					<?= form_open('auth/reset_password/' . $code, ['class' => 'form-signin']) ?>
						<div class="form-label-group">
							...
							<small class="text-danger">Minimal panjang 8 karakter</small>
						</div>

						<div class="form-label-group">
							<input type="password" name="new_confirm" id="new_password_confirm" value="" class="form-control" placeholder="Password Confirmation Baru" required>
							<label for="new_password_confirm">Password Confirmation Baru</label>
						</div>
